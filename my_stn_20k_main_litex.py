...
class BaseSoC(SoCCore):
    def __init__(self, sys_clk_freq=48e6,
        ...
        **kwargs):
        ...
        led5 = platform.request("led_n",4)
        self.specials += Instance("led_sv",
        ...
        class Led(Module, AutoCSR):
            def __init__(self,buttons):
                self.output = CSRStorage(1,description="Led Output(s) Control.") 
                self.output1 = CSRStorage(24,description="Time") 
                leds_m = []
               # for i in range(0,1):
                leds_m.append(self.output.storage[0])
                ...
                leds_h =[]
                #for i in range(5,6):
                leds_h.append(platform.request("led_n",5))
